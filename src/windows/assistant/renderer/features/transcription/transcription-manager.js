...
export function createTranscriptionManager({
    ...
    return {
        ...
        // The live, not-yet-finalized transcript for each source. Vosk only emits
        // a "final" after a pause, so when the user hits Ask AI right after the
        // interviewer finishes, the newest question is still here as a partial.
        getLivePartials: () => ({ system: systemPartialText, mic: micPartialText }),
        handleVoskPartial,
        handleVoskFinal,
        handleVoskStatus,
        handleVoskError,
