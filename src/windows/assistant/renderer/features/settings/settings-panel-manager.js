    ...
    async function openSettings() {
        ...
        try {
            ...
            if (settings && !settings.error) {
                ...
                // Local Ollama is the only AI engine.
                updateProviderVisibility('ollama');

                if (settingOllamaBaseUrl) settingOllamaBaseUrl.value = settings.ollamaBaseUrl || 'http://localhost:11434';
                if (settingOllamaModel) settingOllamaModel.value = settings.ollamaModel || 'qwen2.5vl:3b';
                ...
                if (settingInterviewTopic) settingInterviewTopic.value = settings.interviewTopic || '';
    ...
    async function saveSettings() {
        try {
            ...
            const settings = {
                ...
                interviewTopic: settingInterviewTopic ? settingInterviewTopic.value.trim() : '',
