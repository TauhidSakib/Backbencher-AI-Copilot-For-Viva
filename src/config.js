...
// Local Ollama is the only supported provider (Gemini has been removed).
const AI_PROVIDERS = ['ollama'];
const DEFAULT_AI_PROVIDER = 'ollama';

const DEFAULT_OLLAMA_BASE_URL = 'http://127.0.0.1:11434';
// Single do-everything model. On a 4 GB GPU, using ONE model for both text and
// screenshots means it stays resident (warm) and never swaps — screenshots are
// fast because the model is already loaded, and the GPU never gets overloaded
// by trying to hold two models. qwen2.5vl:3b handles text AND vision/OCR.
...
const KEYBOARD_SHORTCUTS = [
  ...
  {
    id: 'explainDetail',
    buttonLabel: 'Explain in Detail',
    description: 'Explain the previous answer in full, deep detail',
